...
sfInit <- function( parallel=NULL,
  ...
  if( .sfOption$parallel && !nostart ) {
   ...
   ## }
    ...
    ## Ebenso: Timeout - das ist extrem haesslich, wenn das Cluster nicht
    ## korrekt startet und haengen bleibt (z.B. wenn zuviele CPUs fuer das
    ...
    ## @TODO Checken, ob dieser Export wirklich noch benoetigt ist (jan 10)
    else
